...
ALTER TABLE `#__jcomments` CHANGE `object_group` `object_group` VARCHAR(100) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' NOT NULL;
ALTER TABLE `#__jcomments` CHANGE `lang` `lang` CHAR(7) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' NOT NULL;
ALTER TABLE `#__jcomments_objects` CHANGE `object_group` `object_group` VARCHAR(100) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' NOT NULL;
ALTER TABLE `#__jcomments_objects` CHANGE `lang` `lang` CHAR(7) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' NOT NULL;
ALTER TABLE `#__jcomments_subscriptions` CHANGE `object_group` `object_group` VARCHAR(100) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' NOT NULL;
ALTER TABLE `#__jcomments_subscriptions` CHANGE `lang` `lang` CHAR(7) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' NOT NULL;
