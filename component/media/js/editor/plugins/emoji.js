// phpcs:disable
/**
 * SCEditor Emoji Plugin
 * http://www.sceditor.com/
 *
 * Copyright (C) 2017, Sam Clarke (samclarke.com)
 *
 * SCEditor is licensed under the MIT license: http://www.opensource.org/licenses/mit-license.php
 *
 ...
 * @copyright     (C) 2024 Vladimir Globulopolis (https://libra.ms)
...
(function (sceditor) {
	...
	const utils = sceditor.utils,
		// Full Emoji List, v16.0 https://unicode.org/emoji/charts/full-emoji-list.html
		version = '16.0',
		type = 'full + without skin tones',
		list = {
			'smileys': {
				...
				'face-sleepy': '1F60C,1F614,1F62A,1F924,1F634,1FAE9',
			...
			'people': {
				...
				'person-symbol': '1F5E3,1F464,1F465,1FAC2,1F463,1FAC6'
			},
			'component': {
			...
			'nature': {
				...
				'plant-other': '1F331,1FAB4,1F332,1F333,1F334,1F335,1F33E,1F33F,2618,1F340,1F341,1F342,1F343,1FAB9,1FABA,1F344,1FABE'
			},
			'foodstuff': {
				...
				'food-vegetable': '1F951,1F346,1F954,1F955,1F33D,1F336,1FAD1,1F952,1F96C,1F966,1F9C4,1F9C5,1F95C,1FAD8,1F330,1FADA,1FADB,1F344-200D-1F7EB,1FADC',
			...
			'objects': {
				...
				'musical-instrument': '1F3B7,1FA97,1F3B8,1F3B9,1F3BA,1F3BB,1FA95,1F941,1FA98,1FA87,1FA88,1FA89',
				...
				'tool': '1F528,1FA93,26CF,2692,1F6E0,1F5E1,2694,1F4A3,1FA83,1F3F9,1F6E1,1FA9A,1F527,1FA9B,1F529,2699,1F5DC,2696,1F9AF,1F517,26D3-FE0F-200D-1F4A5,26D3,1FA9D,1F9F0,1F9F2,1FA9C,1FA8F',
			...
			'symbols': {
				...
				'other-symbol': '2695,267B,269C,1F531,1F4DB,1F530,2B55,2705,2611,2714,274C,274E,27B0,27BF,303D,2733,2734,2747,00A9,00AE,2122,1FADF',
