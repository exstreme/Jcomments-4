    ...
    public function render()
    {
        ...
        do {
            ...
            for ($i = 0; $i < $this->length; $i++) {
                ...
                imagecopy($img, $font, (int)($x - $shift), (int)$y, $m['start'], 1, $m['end'] - $m['start'], $fontfileHeight);
        ...
        imagestring($img2, 2, (int)($this->width / 2 - imagefontwidth(2) * strlen($credits) / 2), $this->height - 2, $credits, $background);
