...
<div class="col-lg-12">
	<div class="control-group">
		...
		<div class="controls">
			<?php echo HTMLHelper::_('custombbcodes.sample', '\[highlight\=([a-zA-Z0-9].?)\](*.?)\[\/highlight\]'); ?>
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">
		...
		<div class="controls">
			<?php echo HTMLHelper::_('custombbcodes.sample', '&lt;span style="color: ${1};"&gt;${2}&lt;/span&gt;'); ?>
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">
		...
		<div class="controls">
			<?php echo HTMLHelper::_('custombbcodes.sample', '${2}'); ?>
		</div>
	</div>
</div>
