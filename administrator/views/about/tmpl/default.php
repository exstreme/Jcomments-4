...
?>
<form action="<?php echo Route::_('index.php?option=com_jcomments&view=about'); ?>" method="post" name="adminForm"
	  id="adminForm">
		...
		<div class="row-fluid">
			<div id="jcomments-about">
				<table width="95%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td width="50px">
							<img src="components/com_jcomments/assets/images/icon-48-jcomments.png"
								 alt="JComments"/>
						</td>
						<td>
							<div>
							...
							<div class="header">
								<?php echo Text::_('A_ABOUT_TESTERS'); ?>
							</div>

							<div>
								<ul>
									<li>Dutch, b2z, zikkuratvk, ABTOP, SmokerMan, Arkadiy, Gruz, Efanych, Paul
										Geerlings
									</li>
								</ul>
							</div>
							...
							<div class="header">
								<?php echo Text::_('A_ABOUT_TRANSLATORS'); ?>
							</div>
							...
							<div class="header">
								<?php echo Text::_('A_ABOUT_LOGO_DESIGN'); ?>
							</div>
